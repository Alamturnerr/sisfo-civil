...
class UpdateRepositoryCategoryRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'slug' => 'required|min:3|alpha_dash|max:255|unique:repository_categories,slug,'.$this->repository_category->id
        ];
    }
