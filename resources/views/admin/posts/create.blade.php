...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-primary">Form Membuat Berita</h6>
	</div>
	<div class="card-body">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
				    <div class="form-group mb-3">
				        ...
				        <input autocomplete="off" type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Masukan judul berita.." value="{{ old('title') }}">
				        @error('title')
				...
				<div class="col-xs-6 col-sm-6 col-md-6">
				    <div class="form-group mb-3">
						...
						<select class="form-control @error('post_category_id') is-invalid @enderror" id="post_category_id" name="post_category_id">
							<option disabled {{ (old('post_category_id') ? '':'selected') }}>-- Pilih Kategori --</option>
